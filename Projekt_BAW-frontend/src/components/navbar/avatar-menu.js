				...
				<Flex alignItems={'center'}>
					<Menu>
						...
						<MenuList>
							...
							<MenuDivider />
							<MenuItem onClick={() => navigate('/')}>{t('menuList.home')}</MenuItem>
							<MenuItem
								onClick={() => changeLanguage('pl')}
								style={{ display: currentLanguage === 'pl' ? 'none' : 'block' }}
							>
								{t('Polski')}
							</MenuItem>
							<MenuItem
							...
							<MenuItem onClick={() => navigate('/profile')}>{t('menuList.profile')}</MenuItem>
							<MenuDivider />
